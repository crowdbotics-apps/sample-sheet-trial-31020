...
## Project Structure
    ...
    ├── sample_sheet_trial_31020  # Django project configurations
...
1. Clone this repo and `cd sample_sheet_trial_31020`
...
2. Clone this repo and `cd sample_sheet_trial_31020`
